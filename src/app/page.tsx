...
import WidgetCard from "../modules/core/components/widgets/WidgetCard";
...
const Page = () => {
  ...
  return (
    <main className="min-h-screen bg-white ">
      <div className="w-full flex absolute justify-center pt-12 pb-12">
        <h1 className="text-neutral-950 font-regular text-lg">Joan Verhulst</h1>
      </div>
      <div className="flex justify-center items-center min-h-screen py-24 px-16 md:px-0 md:py-0 md:h-screen">
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="aspect-2/1 md:h-full">
                  <WidgetCard
                    label="About"
                    src="/assets/images/about_thumbnail.png"
                    alt="About thumbnail"
                ...
                >
                  ...
                  <div className="aspect-square md:aspect-auto md:h-full">
                    <WidgetCard
                      label="Toolkit"
                      src="/assets/images/toolkit_thumbnail.png"
              ...
              <div className="aspect-2/1  md:h-full md:col-span-2 relative">
                <WidgetCard label="UI/UX" className="h-full bg-neutral-50">
                  {/* Slides wrapper with overflow hidden */}
                  <div className="relative w-full h-full overflow-hidden rounded-2xl">
                    {/* Projects Slide */}
                    <div
                      ref={projectsSlideRef}
                      className="absolute inset-0 bg-linear-to-b from-[#FAF6F6] to-[#EDEDED] rounded-4xl"
                    >
                      <div className="absolute pt-8 px-12 inset-0">
                        <div className="relative border border-neutral-950/10 overflow-hidden rounded-t-4xl h-full">
                          <Image
                            src="/assets/images/design_thumbnail.png"
                    ...
                    <div
                      ...
                      className="absolute inset-0 bg-linear-to-b -translate-y-full from-[#cbd4f0] to-[#8d89c2] rounded-4xl"
                    >
                      <div className="absolute pt-8 px-12 inset-0">
                        <div className="relative border border-neutral-950/10 overflow-hidden rounded-t-2xl h-full">
                          <Image
                            src="/assets/images/art_thumbnail.png"
            ...
            >
              ...
              <div className="aspect-2/1 md:aspect-square w-full md:h-full">
                <WidgetCard
                  label="Photography"
                  src="/assets/images/photog_thumbnail.png"
